...
class Hamburger {
   ...
   */
  calculatePrice() {
    let calculatePrice = Hamburger.SIZES[this._size].price;
    let calculateStuffings = Hamburger.STUFFINGS[this._stuffing].price;
    let priceTopings = this._toppings.reduce((acc, el) => Hamburger.TOPPINGS[el].price + acc, 0);
    return  calculatePrice + calculateStuffings + priceTopings;
   ...
   */
  calculateCalories() {
    let calculateCalories = Hamburger.SIZES[this._size].calories;
    let calculateStuf = Hamburger.STUFFINGS[this._stuffing].calories;
    let caloriesTopings = this._toppings.reduce((acc,el) => Hamburger.TOPPINGS[el].calories + acc , 0);
    return calculateStuf + calculateCalories + caloriesTopings;
  }
}
